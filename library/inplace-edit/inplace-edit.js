                        ...
                        if($("#" + divid).length) {
                            ...
                            var formHTML = '<div class="inplace-edit-container" id="' + divid + '" style="display: none">';
                                ...
                                if(options.field == "title") {
                                    ...
                                    formHTML += '<textarea class="inputtable" id="' + divid + '-inputtable" name="post_content">' + $.trim($element.text()) + '</textarea>';
                                } else if( options.field == "excerpt" ) {
                                    formHTML += '<textarea class="inputtable" id="' + divid + '-inputtable" name="post_excerpt">' + $.trim($element.text()) + '</textarea>';
                                }
